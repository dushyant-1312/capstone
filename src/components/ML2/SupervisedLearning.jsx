...
export const SupervisedLearning = () => {
  ...
  const topics = [
    {
      title: "Regression",
      desc: "Predicting continuous numerical values. Linear, Polynomial, and Ridge regression models.",
      path: "/Regression",
      color: "blue",
      difficulty: "Beginner",
      icon: <TrendingUp />,
    ...
    },
    {
      ...
      desc: "Categorizing data into discrete classes. Logistic Regression, k-NN, and Naive Bayes.",
      path: "/Classification",
      color: "emerald",
      difficulty: "Beginner",
      icon: <Target />,
    ...
    },
    {
      ...
      desc: "Tree-based logic for both classification and regression. Entropy and Information Gain.",
      path: "/DecisionTrees",
      color: "amber",
    ...
    {
      title: "SVM & Ensembles",
      desc: "Advanced boundaries with Support Vector Machines and Random Forests.",
      path: "/SVMEnsembles",
      color: "rose",
      difficulty: "Advanced",
      icon: <ShieldCheck />,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          <h1 className={`text-5xl font-black tracking-tight mb-4 ${darkMode ? "text-white" : "text-slate-900"}`}>
            Supervised <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-pink-500">Learning.</span>
          </h1>
          <p className={`text-lg max-w-xl ${darkMode ? "text-slate-400" : "text-slate-600"}`}>
            Learn how to train models using labeled examples to predict future outcomes and classify unseen data.
          </p>
        </div>
            ...
            <NavLink to={topic.path} key={index} className="group relative">
              ...
              `}>
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className={`text-2xl font-bold mb-3 transition-colors ${darkMode ? "text-white group-hover:text-orange-400" : "text-slate-900 group-hover:text-orange-600"}`}>
                    {topic.title}
                  </h3>
                  ...
                  <div className={`mt-auto flex items-center justify-between pt-6 border-t ${darkMode ? "border-zinc-800" : "border-slate-100"}`}>
                    ...
                    <div className={`flex items-center text-sm font-bold transition-all ${darkMode ? "text-white group-hover:text-orange-400" : "text-slate-900 group-hover:text-orange-600"} group-hover:translate-x-1`}>
                      Train Model <ArrowRight className="ml-2 w-4 h-4" />
                    </div>
                  </div>
                </div>
              </div>

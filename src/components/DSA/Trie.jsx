  ...
  const topics = [
    {
      ...
      desc: "Node structure, insert, search, and startsWith implementation details.",
      path: "/Trie1",
      color: "blue",
    ...
    },
    {
      ...
      desc: "Mastering Word Search II, Prefix Trees, and Auto-complete patterns.",
      path: "/Trie2",
      color: "rose",
      difficulty: "Advanced",
      icon: <Trophy />,
    ...
    },
    {
      ...
      desc: "Advanced applications: Bitwise Tries, XOR puzzles, and maximum efficiency.",
      path: "/Trie3",
      color: "violet",
      difficulty: "Expert",
      icon: <Flame />,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          <h1 className={`text-5xl font-black tracking-tight mb-4 ${darkMode ? "text-white" : "text-slate-900"}`}>
            Trie <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-pink-500">Mastery.</span>
          </h1>
          <p className={`text-lg max-w-xl ${darkMode ? "text-slate-400" : "text-slate-600"}`}>
            Master the Prefix Tree logic that powers modern search engines, IP routing, and predictive text systems.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {topics.map((topic, index) => (
            <NavLink to={topic.path} key={index} className="group relative flex flex-col">
              <div className={`
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className={`mt-auto flex items-center justify-between pt-6 border-t ${darkMode ? "border-zinc-800" : "border-slate-100"}`}>
                    <span className={`flex items-center text-xs font-medium ${darkMode ? "text-slate-500" : "text-slate-400"}`}>
                      <Circle className="w-2 h-2 mr-2 fill-violet-500 stroke-none" />
                      {topic.stats}
                    </span>
